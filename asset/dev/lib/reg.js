...
STK.register("core.dom.sizzle", function (a) {
    ...
    var i = function (a, b, c, e) {
        ...
        if (h.length > 1 && k.exec(a))
            if (h.length === 2 && j.relative[h[0]]) m = q(h[0] + h[1], b);
            else {
        ...
        if (f.call(o) === "[object Array]")
            if (!r) c.push.apply(c, o);
            else if (b && b.nodeType === 1)
            for (x = 0; o[x] != null; x++) o[x] && (o[x] === !0 || o[x].nodeType === 1 && i.contains(b, o[x])) && c.push(m[x]);
        else
            for (x = 0; o[x] != null; x++) o[x] && o[x].nodeType === 1 && c.push(m[x]);
        else n(o, c); if (p) {
            i(p, g, c, e);
            i.uniqueSort(c)
        }
    ...
    var j = {
        ...
        preFilter: {
            ...
            PSEUDO: function (a, b, c, e, f) {
                if (a[1] === "not")
                    if ((d.exec(a[3]) || "").length > 1 || /^\w/.test(a[3])) a[3] = i(a[3], null, null, b);
                    else {
    ...
    try {
        ...
        n = function (a, b) {
            ...
            if (f.call(a) === "[object Array]") Array.prototype.push.apply(c, a);
                ...
                for (var e = a.length; d < e; d++) c.push(a[d]);
            else
                for (; a[d]; d++) c.push(a[d]);
            return c
        }
    }
    var p;
...
STK.register("core.str.decodeHTML", function (a) {
    return function (a) {
        ...
        return a.replace(/&quot;/g, '"').replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&#39;/g, "'").replace(/&nbsp;/g, "è½").replace(/&#32;/g, " ").replace(/&amp;/g, "&")
    }
});
    ...
    return function (b) {
        ...
        c.on = function (d, f) {
            for (var g = 0, h = e.length; g < h; g += 1)
                if (e[g].fn === f && e[g].type === d) return c;
            e.push({
                fn: f,
                type: d
            });
...
STK.register("core.dom.selector", function (a) {
    var b = function (b, c, d, e) {
        ...
        if (typeof b == "string") {
            ...
            if (c)
                for (var h = 0, i = b.length; h < i; h += 1) a.core.dom.contains(c, b[h]) && f.push(b[h]);
            else f = b;
        return f
    };
...
STK.register("core.obj.isEmpty", function (a) {
    return function (a, b) {
        for (var c in a)
            if (b || a.hasOwnProperty(c)) return !1;
        return !0
    }
});
STK.register("core.evt.delegatedEvent", function (a) {
    var b = function (b, c) {
        for (var d = 0, e = b.length; d < e; d += 1)
            if (a.core.dom.contains(b[d], c)) return !0;
        return !1
    };
    return function (c, d) {
        ...
        h.removeExcept = function (a) {
            if (!a) d = [];
                ...
                for (var b = 0, c = d.length; b < c; b += 1) d[b] === a && d.splice(b, 1)
        };
    ...
    var d = function (b, d, e, f) {
        ...
        return g
            ...
            add: function (f, g, h, i) {
                if (a.core.arr.isArray(g))
                    for (var j = 0; j < g.length; j++) e.add(f, g[j], h, i);
                else {
                    var k = d(f, g, h, i);
                    if (!k.keys) return;
                    g = k.keys;
            ...
            remove: function (f, g, h, i) {
                if (a.core.arr.isArray(g))
                    for (var j = 0; j < g.length; j++) e.remove(f, g[j], h, i);
                else {
                    var k = d(f, g, h, i);
                    if (!k.keys) return;
                    g = k.keys;
        ...
        if (typeof a == "object")
            for (var e in a) {
                ...
                if (a[e] instanceof Array)
                    for (var f = 0, g = a[e].length; f < g; f++) d.push(e + "=" + b(a[e][f], c));
            ...
            if (typeof b[c] == "object")
                if (b[c] instanceof Array) {
                    ...
                    for (var d = 0, e = b[c].length; d < e; d += 1)
                        if (!arguments.callee(b[c][d], a[c][d])) return !1
                } else {
    ...
    var b = function (a) {
        ...
        l = function (a, b) {
            var l, m, n, o = [],
                ...
                q = function (c, d, k, l) {
                    if (g[d])
                        while (o.last() && h[o.last()]) r("", o.last());
                    i[d] && o.last() == d && r("", d);
                    l = f[d] || !! l;
                    l || o.push(d);
                    var m = [];
...
STK.register("core.util.pageletM", function (a) {
    ...
    var m = function (b, c) {
        ...
        if (a.IE) {
            ...
            if (e)
                for (var f = 0, g = e.length; f < g; ++f) j[b].css[c + e[f]] = 1
        }, r = function () {
            for (var a in i) {
                var b = !1,
                    c = i[a].cssURL;
...
STK.register("core.util.swf", function (a) {
    function b(b, c) {
        ...
        if (b == null) throw "swf: [sURL] éˆî„ç•¾æ¶”ï¿½";
        var e, f = [],
            g = [];
    ...
    c.create = function (c, d, e) {
        var f = a.E(c);
        if (f == null) throw "swf: [" + c + "] éˆî…å£˜é’ï¿½";
        var g = b(d, e);
        f.innerHTML = g.html;
        return a.E(g.id)
    };
...
STK.register("ui.mod.layer", function (a) {
    var b = function (a) {
        ...
        return b
            ...
            } else e = a.core.dom.position(c); if (d !== "topleft") {
                var f = b(c);
    ...
    return function (d) {
        var e = a.core.dom.builder(d),
            ...
            i = {}, j = a.core.evt.custEvent.define(i, "show");
        ...
        if (!c) {
            var e, f = {
                    ...
                    pars: function () {
                        ...
                        e = a.parseParam({
                            login: 1
                        }, a.queryToJson(d.getAttribute("action-data") || ""));
                    ...
                    var b = function (a) {
                        window.location.reload()
                            ...
                            a.ui.alert(b.msg)
                        }, d = a.common.trans.global.getTrans("language", {
                            onSuccess: b,
                            onError: c
                        });
                    return function (a) {
                ...
                h = {
                    change: function () {
                        ...
                        a.ui.confirm(b("#L{ç¡®è®¤åˆ‡æ¢åˆ°}") + f.innerHTML + b("#L{ç‰ˆå—ï¼Ÿ}"), {
                            OK: function () {
                                a.preventDefault();
                                if (e.login) g(c);
                                else {
...
STK.register("common.listener", function (a) {
    ...
    c.define = function (c, d) {
        if (b[c] != null) throw "common.listener.define: é¢‘é“å·²è¢«å ç”¨";
        b[c] = d;
        var e = {};
        e.register = function (d, e) {
            if (b[c] == null) throw "common.listener.define: é¢‘é“æœªå®šä¹‰";
            a.listener.register(c, d, e)
        };
        e.fire = function (d, e) {
            if (b[c] == null) throw "commonlistener.define: é¢‘é“æœªå®šä¹‰";
...
function SSOController() {
    ...
    this.checkAltLoginNameCallback = function (a) {
        ...
        if (a.ret == "y") {
            b.retcode = 1;
            b.detail = 'ä¸ºäº†æ‚¨çš„è´¦å·å®‰å…¨ï¼Œè¯·<a href="http://login.sina.com.cn/bindmail/signin.php?username=' + s.username + '">ç»‘å®šé‚®ç®±</a>';
            b.data = s.username
        } else if (a.ret == "n" && a.mail)
            if (a.errcode == "not_verify") {
                b.retcode = 2;
                b.detail = "æ‚¨çš„é‚®ç®±: " + a.mail + ' æœªéªŒè¯ï¼Œç‚¹æ­¤<a href="http://login.sina.com.cn/bindmail/bindmail1.php?entry=sso&user=' + a.mail + '">é‡å‘éªŒè¯é‚®ä»¶</a>';
                b.data = a.mail
            } else {
                b.retcode = 3;
                b.detail = "ç”¨æ‚¨çš„é‚®ç®±" + a.mail + "ä¹Ÿå¯ä»¥ç™»å½•";
                b.data = a.mail
            }
        s.callback(b)
    };
                ...
                extraType: function (a) {
                    if (!d.extraRule) {
                        ...
                        for (b in d.extraConf)
                            for (c in d.extraConf[b]) d.extraRule["" + d.extraConf[b][c]] = b
                    }
...
STK.register("common.trans.account", function (a) {
    ...
    c("bindfacebook", {
        url: "/bindsns/aj/bindfacebook",
        method: "post"
    });
    c("updatebindfacebook", {
        url: "/bindsns/aj/sendtofacebook",
        method: "post"
    });
    c("unbindfacebook", {
        url: "/bindsns/aj/unbindfacebook",
        method: "post"
    });
    return b
});
    ...
    return function (e, f) {
        var g, h = {
                ...
                destroy: function () {
                    g.destroy();
                    for (var b in k)
                        for (var c in h) a.removeEvent(b.el, c, h[c])
                },
...
STK.register("common.setting.email", function (a) {
    var b = {
        E01: "",
        E02: "#L{æ‚¨å¡«å†™çš„é‚®ç®±å°†ä½œä¸ºå¾®åšç™»å½•å}",
        E03: "#L{è¯·è¾“å…¥æ­£ç¡®çš„é‚®ç®±åœ°å€}",
        E04: "#L{æ–°æµªå¾®åšå·²åœæ­¢é›…è™Žé‚®ç®±æ³¨å†Œ}"
    };
    return function (c, d) {
        var e, f = function () {
                var a = i.value(),
            ...
            }, i = a.common.setting.control(c, d, {
                evtAct: h,
                check: f
            }),
            j = a.core.obj.sup(i, ["initPars"]);
        i.initPars = function () {
            j.initPars();
...
STK.register("common.setting.password", function (a) {
    var b = {
        E01: "",
        E02: "#L{è¯·è¾“å…¥6-16ä½æ•°å­—ã€å­—æ¯æˆ–å¸¸ç”¨ç¬¦å·ï¼Œå­—æ¯åŒºåˆ†å¤§å°å†™}",
        E03: "#L{è¯·è¾“å…¥å¯†ç }",
        E04: "#L{è¯·è¾“å…¥6-16ä½æ•°å­—ã€å­—æ¯æˆ–å¸¸ç”¨ç¬¦å·ï¼Œå­—æ¯åŒºåˆ†å¤§å°å†™}",
        E05: "#L{è¯·è¾“å…¥6-16ä½æ•°å­—ã€å­—æ¯æˆ–å¸¸ç”¨ç¬¦å·ï¼Œå­—æ¯åŒºåˆ†å¤§å°å†™}",
        E06: "#L{æ‚¨çš„å¯†ç å¾ˆå®‰å…¨}",
        E07: "#L{æ‚¨çš„å¯†ç è¿˜å¯ä»¥æ›´å¤æ‚äº›}",
        E08: "#L{å¼±ï¼šæ‚¨è¾“å…¥çš„å¯†ç å¼ºåº¦è¿‡å¼±ï¼Œè¯·é‡æ–°è¾“å…¥ï¼Œè¯•è¯•å­—æ¯ã€æ•°å­—ã€å¸¸ç”¨ç¬¦å·çš„ç»„åˆ}"
    };
    return function (c, d) {
        var e = function (a) {
            return i.rule.isWeakPasswd(a) ? 0 : i.rule.isStrongPasswd(a) ? 2 : 1
        }, f = function () {
                var a = i.value().replace(/^\s+|\s+$/g, ""),
                    b = !1;
                if (!i.pars.must && i.rule.isEmpty(a)) {
                    i.msg.state = !0;
                    i.msg.type = "empty";
                    ...
                    if (!b && !i.rule.lenLimit(a, 6, 16)) {
                        b = !0;
                        i.msg.type = "err";
                        i.msg.code = "E04"
                    }
                    if (!b && i.rule.isWeird(a)) {
                        b = !0;
                        i.msg.type = "err";
                        i.msg.code = "E05"
                    }
            ...
            h = {
                ...
                keydown: function (b) {
                    var c, d; !! (c = b) && !! (d = c.keyCode) && d == 32 && a.stopEvent()
                },
                keyup: function (a) {
                    var b, c;
                    if ( !! (b = a) && !! (c = b.keyCode)) {
...
STK.register("common.setting.nickname", function (a) {
    var b = {
        E01: "",
        E02: "#L{è¯·è¾“å…¥4-24ä½å­—ç¬¦ï¼šæ”¯æŒä¸­æ–‡ã€è‹±æ–‡ã€æ•°å­—ã€â€œ-â€ã€â€œ_â€}",
        E03: "#L{æ˜µç§°ä¸èƒ½å…¨æ˜¯æ•°å­—}",
        E04: "#L{è¯·è¾“å…¥4-24ä½å­—ç¬¦ï¼šæ”¯æŒä¸­æ–‡ã€è‹±æ–‡ã€æ•°å­—ã€â€œ-â€ã€â€œ_â€}",
        E05: "#L{è¯·è¾“å…¥4-24ä½å­—ç¬¦ï¼šæ”¯æŒä¸­æ–‡ã€è‹±æ–‡ã€æ•°å­—ã€â€œ-â€ã€â€œ_â€}",
        E06: "#L{è¯·è¾“å…¥æ˜µç§°}"
    };
    return function (c, d) {
        var e, f = function () {
                ...
                if (!i.pars.must && i.rule.isEmpty(a)) {
                    ...
                    if (!b && i.rule.isNumber(a)) {
                        b = !0;
                        i.msg.type = "err";
                        i.msg.code = "E03"
                    }
                    if (!b && !i.rule.isName(a)) {
                        b = !0;
                        i.msg.type = "err";
                        i.msg.code = "E04"
                    }
                    if (!b && !i.rule.lenLimit(a, 4, 24)) {
                        b = !0;
                        i.msg.type = "err";
                        i.msg.code = "E05"
                    }
...
STK.register("common.setting.jumpStatics", function (a) {
    ...
    return function (c) {
        var d = {};
        c = a.parseParam({
            listenTarget: document.documentElement,
            analyticsLink: "",
            judge: b
        }, c);
        var e = c.listenTarget,
            f = c.analyticsLink;
        if (a.isNode(e) && f) {
            var g = function (b) {
                b = a.fixEvent(b);
...
STK.register("common.layer.emailAutocomplete", function (a) {
    var b = a.kit.extra.textareaUtils,
        ...
        e = {
            panel: ['<div node-type="layer" class="layer_menu_list" style="display:none;">', '<ul><li class="note">#L{è¯·é€‰æ‹©é‚®ç®±ç±»åž‹}</li></ul>', '<ul node-type="panel"></ul>', "</div>"].join(""),
...
STK.register("common.dialog.authentication", function (a) {
    return function (b) {
        ...
        b = a.parseParam({
            src: "http://account.weibo.com/sguide/identity/iframe?from=home_verification",
            icon: "warn",
            isHold: !0,
            width: "455px",
            height: "180px",
        ...
        var e = {}, f, g, h = !1,
            ...
            j = {
                init: function () {
                    ...
                    e.push(c("#L{æ‚¨çš„èº«ä»½ä¿¡æ¯å°šæœªéªŒè¯é€šè¿‡ï¼Œè¯·å°½å¿«éªŒè¯ã€‚å®ŒæˆéªŒè¯åŽï¼Œå¯ä»¥ä½¿ç”¨å…¨éƒ¨å¾®åšåŠŸèƒ½ï¼Œæ‚¨çš„å¸å·ä¹Ÿå°†æ›´åŠ å®‰å…¨ã€‚}"));
                    e.push('<a suda-data="key=tblog_checkfailed_reform&value=checkfailed_readonly" class="S_spetxt" href="http://weibo.com">');
                    e.push(c("#L{å…ˆä½“éªŒå¾®åšï¼Œç¨å€™å†éªŒè¯}"));
                    e.push("</a>");
                    e.push("</p></dd></dl>");
                ...
                verifySucc: function () {
                    ...
                    var b = {
                        ...
                        OKText: c("#L{è¿›å…¥é¦–é¡µ}"),
                        msg: c("#L{æ­å–œï¼Œæ‚¨çš„èº«ä»½å·²éªŒè¯æˆåŠŸï¼Œé©¬ä¸Šè¿›å…¥æ–°æµªå¾®åšã€‚}")
                ...
                verifyFail: function () {
                    ...
                    var b = {
                        ...
                        OKText: c("#L{å†æ¬¡éªŒè¯}"),
                        msg: c("#L{æŠ±æ­‰ï¼Œæ‚¨çš„èº«ä»½ä¿¡æ¯ä¸å‡†ç¡®ï¼Œè¯·å†æ¬¡éªŒè¯ã€‚<br/>}") + '<a class="S_spetxt" suda-data="key=tblog_checkfailed_reform&value=checkfailed_havealook" href="http://weibo.com">' + c("#L{æ‚¨ä¹Ÿå¯ä»¥å…ˆä½“éªŒå¾®åšï¼ŒéšåŽå†éªŒè¯èº«ä»½ä¿¡æ¯>>}") + "</a>"
                    }, d = a.ui.alert(b.msg, b);
                    a.custEvent.add(d, "hide", function () {
                        history.go(0)
                    })
...
STK.register("common.layer.ioError", function (a) {
    ...
    return function (d, e, f) {
        var g = {}, h, i, j = function () {}, k = {
                title: b("#L{å‘å¸ƒå¤±è´¥}"),
                warnMsg: b("#L{è¯¥ç»„æˆå‘˜å·²è¾¾ä¸Šé™ï¼Œä¸èƒ½å¯¹è¯¥ç»„å‘å¸ƒå®šå‘å¾®åšã€‚}"),
                OKText: b("#L{çŸ¥é“äº†}"),
                textComplex: b('#L{å¾®åšä¼šå‘˜å¯ä»¥æé«˜åˆ†ç»„ä¸Šé™} <a href="http://vip.weibo.com/prividesc?priv=1110">#L{äº†è§£æ›´å¤š}Â»</a>'),
                vip: b("#L{å¼€é€šä¼šå‘˜}")
            }, l = {
                init: function () {
                    l.data()
                ...
                data: function () {
                    ...
                    h = a.parseParam({
                        ...
                        title: b("#L{æç¤º}"),
                        OKText: b("#L{ç¡® å®š}"),
                        cancelText: b("#L{å– æ¶ˆ}"),
                        suda: ""
                    }, e.data);
                    h.msg = e.msg || b("#L{ç³»ç»Ÿç¹å¿™}");
                    h.OK = function () {
                        a.preventDefault();
...
STK.register("common.layer.errTip", function (a) {
    var b = '<div node-type="outer" style="position: absolute; top: 100px; left: 68px;" class="layer_tips"><div node-type="inner" class="error"><div class="error_text"><span node-type="ico" class="icon"></span><span node-type="msg">å¤§å†™é”å®šå·²æ‰“å¼€ï¼Œè¯·æ³¨æ„å¤§å°å†™</span></div></div><a action-type="common_layer_errtip_close" href="javascript:;" class="W_close_color" node-type="close"></a><span node-type="arrow" class="arrow_down"></span></div>';
    return function (c) {
        var d = {}, e, f, g, h, i = {
...
STK.register("common.setting.vsncode", function (a) {
    var b = {
        E01: "",
        E02: "#L{è¯·è¾“å…¥å¾®ç›¾åŠ¨æ€ç }",
        E03: "#L{åŠ¨æ€ç æœ‰è¯¯ï¼Œè¯·é‡æ–°è¾“å…¥}"
    };
    return function (c, d) {
        var e = function () {
            var a = g.value().replace(/^\s+|\s+$/g, ""),
...
STK.register("common.login.form", function (a) {
    var b = ["username", "password", "verifycode", "vsncode"],
        ...
        h = {
            CAPSLOCK: "#L{é”®ç›˜å¤§å†™é”å®šå·²æ‰“å¼€ï¼Œè¯·æ³¨æ„}",
            ERRTIP: {
                ...
                CODE: {
                    4038: '#L{ç™»å½•æ¬¡æ•°è¿‡äºŽé¢‘ç¹ï¼Œ}<a href="http://help.weibo.com/faq/q/85/12699#12699" target="_blank">#L{æŸ¥çœ‹å¸®åŠ©}</a>',
                    4049: "#L{è¯·å¡«å†™éªŒè¯ç }",
                    4010: '#L{å¸å·å°šæœªæ¿€æ´»ã€‚}<a target="_blank" href="http://weibo.com/signup/v5/resend?username=#{USERNAME}">#L{é‡å‘æ¿€æ´»é‚®ä»¶}</a>',
                    4090: "#L{æ­¤å¸å·æœªæ¿€æ´»ï¼Œè¯·ç™»å½•åŽŸå¸å·}",
                    5024: "#L{è¯·å¡«å†™æ­£ç¡®çš„å¾®ç›¾åŠ¨æ€ç }",
                    5025: "#L{åŠ¨æ€ç æœ‰è¯¯ï¼Œè¯·é‡æ–°è¾“å…¥}",
                    5: '#L{å°šæœªæ³¨å†Œå¾®åšï¼Œ}<a href="http://weibo.com/signup/signup.php">#L{é©¬ä¸Šæ³¨å†Œ}</a>',
                    101: '#L{ç”¨æˆ·åæˆ–å¯†ç é”™è¯¯ã€‚}<a href="http://help.weibo.com/faq/q/85/12606#12606" target="_blank">#L{æŸ¥çœ‹å¸®åŠ©}</a>'
                }
            },
            SAVE_STATE_LAYER: '<div class="layer_pop" node-type="outer" style="position:absolute;"><p node-type="content"></p></div>',
            MAIN: '<div node-type="username_box" class="info_list"><div class="inp username"><input autocomplete="off" maxlength="128" tabindex="1" node-type="username" name="username" type="text" class="W_input" action-type="text_copy" action-data="text=#L{é‚®ç®±/ä¼šå‘˜å¸å·/æ‰‹æœºå·}" value="" /></div></div><div node-type="password_box" class="info_list"><div class="inp password"><input maxlength="24" tabindex="2" node-type="password" name="password" type="password" class="W_input" action-type="text_copy" value="" /><span class="enter_psw">#L{è¯·è¾“å…¥å¯†ç }</span></div></div><div node-type="verifycode_box" class="info_list" style="display: none;"><div class="inp verify"><input maxlength="6" tabindex="3" node-type="verifycode" name="verifycode" type="text" class="W_input" value="" action-type="text_copy" action-data="text=#L{è¯·è¾“å…¥éªŒè¯ç }" /><a class="code" href="javascript:void(0);" onclick="return false;"><img src="" node-type="verifycode_image" action-type="btn_change_verifycode" width="100" height="40"></a><a node-type="btn_change_verifycode" action-type="btn_change_verifycode" class="verify_refresh" href="javascript:void(0);" onclick="return false;"></a></div></div><div node-type="vsncode_box" class="info_list" style="display: none;"><div class="inp wei_dun"><input maxlength="6" tabindex="4" node-type="vsncode" name="vsncode" type="text" class="W_input" action-type="text_copy" action-data="text=#L{è¯·è¾“å…¥å¾®ç›¾åŠ¨æ€ç }" value="" /><a node-type="btn_vsncode_recover" href="http://account.weibo.com/forgot/vdun">#L{å¾®ç›¾æŒ‚å¤±}</a></div></div><div class="info_list clearfix"><div class="right"><a suda-data="key=tblog_weibologin3&value=click_forgetpwd" target="_blank" node-type="btn_password_recover" href="https://login.sina.com.cn/getpass.html?entry=weibo">#L{å¿˜è®°å¯†ç }</a></div><label action-type="customTip" action-data="content=#L{å»ºè®®åœ¨ç½‘å§æˆ–å…¬å…±ç”µè„‘ä¸Šå–æ¶ˆè¯¥é€‰é¡¹ã€‚}" title="#L{å»ºè®®åœ¨ç½‘å§æˆ–å…¬å…±ç”µè„‘ä¸Šå–æ¶ˆè¯¥é€‰é¡¹ã€‚}" for="login_form_savestate"><input tabindex="5" id="login_form_savestate" checked="checked" node-type="savestate" type="checkbox" class="W_checkbox" />#L{ä¸‹æ¬¡è‡ªåŠ¨ç™»å½•}</label><a suda-data="key=tblog_weibologin3&value=click_help" action-type="customTip" action-data="content=#L{è®°ä¸ä½ç™»å½•çŠ¶æ€ï¼Œæ€Žä¹ˆåŠžï¼Ÿ}" title="#L{è®°ä¸ä½ç™»å½•çŠ¶æ€ï¼Œæ€Žä¹ˆåŠžï¼Ÿ}" target="_blank" class="icon_ask" href="http://help.weibo.com/faq/q/85/12524#12524"></a></div><div class="info_list no_reg"><a tabindex="6" suda-data="key=tblog_weibologin3&value=click_sign" node-type="submitBtn" action-type="btn_submit" class="W_btn_g" href="javascript:void(0)"><span node-type="submitStates">#L{ç™»å½•}</span></a><span class="no_reg_tip">#L{è¿˜æ²¡æœ‰å¾®åšï¼Ÿ}<a suda-data="key=tblog_weibologin3&value=click_register" target="_blank" href="http://weibo.com/signup/signup.php">#L{ç«‹å³æ³¨å†Œï¼}</a></span></div>',
            SUBMIT: {
                NORMAL: "#L{ç™»å½•}",
                ONSUBMIT: '<b class="loading"></b>#L{ç™»å½•}'
            }
        }, i = {
        ...
        var n, o, p, q, r = {}, s, t, u, v, w = {
                ...
                lock: function (a) {
                    if (typeof a != "undefined" && o.ctls[a]) o.ctls[a].disabled(1);
                        ...
                        for (var a in o.ctls) o.ctls[a].disabled(1)
                },
                unlock: function () {
...
STK.register("common.dialog.login", function (a) {
    var b = {
        FRAME: '<div class="ly_loginleft"><p class="info">#L{å·²æœ‰æ–°æµªåšå®¢ï¼Œæ–°æµªé‚®ç®±å¸å·ï¼Œå¯ç›´æŽ¥ç™»å½•}</p><div class="W_login_form" node-type="loginForm"></div><p class="otherlogin"><a target="_blank" href="http://weibo.com/bind/index.php">#L{ä½¿ç”¨å…¶ä»–å¸å·ç™»å½•}</a></p></div><div class="ly_loginright"><p class="p1">#L{è¿˜æ²¡æœ‰å¼€é€šï¼Ÿ}</p><p class="p2">#L{èµ¶å¿«å…è´¹æ³¨å†Œä¸€ä¸ªå§ï¼}</p><div><a class="btn_reg" href="http://weibo.com/signup/signup.php">#L{ç«‹å³å…è´¹æ³¨å†Œ}</a></div></div>',
        TITLE: "#L{ç™»å½•æˆ–æ³¨å†Œ}"
    }, c = a.ui.dialog({
            isHold: !0
        });
    a.core.dom.setStyle(c.getOuter(), "textAlign", "left");
    var d = c.getInner();
    a.core.dom.setStyle(d, "width", "500px");
    return function () {
        var e, f, g = {
                init: function () {
                    g.parseParam();
                ...
                parseParam: function () {
                    b = a.common.extra.parseLanguage(b)
                },
                show: function () {
                    d.className = "layer_login clearfix";
                    c.setTitle(b.TITLE);
                    c.setContent(b.FRAME);
                    e = a.kit.dom.parseDOM(a.builder(d).list);
                    c.show();
                    f = a.common.login.form(e.loginForm);
                    c.setMiddle()
                },
                bind: function () {
                    a.custEvent.add(c, "hide", function () {
                        f.destroy();
                        f = e = null;
                        a.custEvent.remove(c, "hide", arguments.callee)
                    })
                }
            };
        g.init();
